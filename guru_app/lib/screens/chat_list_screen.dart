...
import 'package:guru_app/screens/conversation_screen.dart';
...
class ChatListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final currentUserAsyncValue = ref.watch(currentUserStreamProvider); // StreamProvider
              ...
              if (conversations.isEmpty) {
                return Center(
                  child: Column(
                    ...
                    children: const [
                      Icon(Icons.chat_bubble_outline, size: 48, color: Color(0xFF1769E0)),
                      SizedBox(height: 10),
                  ...
                  return ListTile(
                    leading: CircleAvatar(
                      ...
                      child: conversationUser.avatarUrl == null
                          ? const Icon(Icons.person, color: Color(0xFF1769E0))
                          : null,
                    ),
                    ...
                    trailing: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: const Text('5m ago', style: TextStyle(color: Color(0xFF1769E0))),
                        ),
